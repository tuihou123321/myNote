  ...
  return function (t) {
          ...
          for (var e = Object(t), r = 1; r < arguments.length; r++) {
            ...
            if (void 0 !== o && null !== o) {
              ...
              for (var n = Object.keys(Object(o)), i = 0, a = n.length; i < a; i++) {
                var s = n[i], u = Object.getOwnPropertyDescriptor(o, s);
    ...
    var o = r(2), n = function () {
      function t(t) {
        ...
        var o = r.getContext("2d"), n = (t.width - 2 * t.padding) / e.getModuleCount(),
        ...
        for (var s = 0; s < e.getModuleCount(); s++) for (var u = 0; u < e.getModuleCount(); u++) {
          ...
          var h = Math.ceil((u + 1) * n) - Math.floor(u * n), f = Math.ceil((s + 1) * n) - Math.floor(s * n);
      ...
      return e.getQrBase64 = function (e, r) {
        "string" != typeof e && (e = ""), "string" == typeof r ? r = {text: r} : "object" != typeof r && (r = {}), r = Object.assign({
          padding: 10,
          width: 256,
          height: 256,
          typeNumber: -1,
    ...
    r.prototype = {
      ...
      addData: function (t) {
        ...
        var o = t.createEmptyMovieClip(e, r), n = 1;
        this.make();
        for (var i = 0; i < this.modules.length; i++) for (var a = i * n, s = 0; s < this.modules[i].length; s++) {
          var u = s * n, h = this.modules[i][s];
      ...
      for (var r = 0, o = 0, i = 0, a = new Array(e.length), s = new Array(e.length), u = 0; u < e.length; u++) {
        ...
        r += h;
        var c = f.getErrorCorrectPolynomial(l), d = new n(a[u], c.getLength() - 1), v = d.mod(c);
    ...
    n.prototype = {
      ...
      for (var o = r.length / 3, n = new Array, a = 0; a < o; a++) for (var s = r[3 * a + 0], u = r[3 * a + 1], h = r[3 * a + 2], f = 0; f < s; f++) n.push(new i(u, h));
      return n
