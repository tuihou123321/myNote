...
import UserCourseLists from "../../components/UserCourseLists/UserCourseLists"
import {getUserCourseLists} from "../../api/api"
...
export default class UserCourse extends Component {
  ...
  loadMore=()=>{
    ...
    getUserCourseLists(param,(result)=>{
  ...
  render() {
    ...
    return (<div>
      <div style={{background:"#f2f5f7"}}>
        <Header title="我的课程" border="true"  history={history}/>
        {UserCourseLists(this.state.listsData)}
