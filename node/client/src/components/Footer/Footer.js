          ...
          <div className="bg-white">
              <footer className="tac pt40 pb20">
                  <div className="mb20 fz15">
                      ...
                      <p>服务热线：<a href={"tel:4001141010"} className="blue b fz16">400-114-1010</a></p>
                      <p className="fz11 grey">(工作时间：全年无休，尽快与您取得联系)</p>
                  </div>

                  {/*<div className="tac">*/}
                      {/*<div className="dib p5 bd1 mb20 fz12 tac">*/}
                          {/*<img src={require("../../static/images/code.png")} alt="" style={{width:"1.23rem"}}/>*/}
                          {/*<p>客服微信，随时解答</p>*/}
                      {/*</div>*/}
                  {/*</div>*/}
